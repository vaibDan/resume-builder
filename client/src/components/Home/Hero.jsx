            ...
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    <a href="https://prebuiltui.com">
                        <img src="./logo.svg" alt="logo" srcset="" className='w-auto h-11' />
                    </a>
                    ...
                    <div className="hidden md:flex items-center gap-8 transition duration-500 text-slate-800">
                        ...
                        <a href="#contacts" className="hover:text-green-600 transition">Contact</a>
                    </div>
                    ...
                    <div className="flex gap-2">
                        ...
                        <Link to='/app' className="hidden md:block px-6 py-2 border active:scale-95  bg-green-500 hover:bg-green-700 transition-all rounded-full text-white"
                            hidden={!user}>
                            Dashboard
                        </Link>
                    </div>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        Land in your dream job with <span className=" bg-gradient-to-r from-green-700 to-green-600 bg-clip-text text-transparent text-nowrap">AI powered </span> resumes.
                    </h1>
                    ...
                    <div className="flex flex-wrap justify-between max-sm:justify-center gap-6 max-w-3xl w-full mx-auto py-4" id="logo-container">
                        {logos.map((logo, index) => <img key={index} src={logo} alt="logo" className="h-6 w-auto max-w-xs object-contain" />)}
                    </div>
                </div>
            </div>
            <style>
