                ...
                <div className="col-span-1  py-10">
                    ...
                    {data.personal_info?.image ? (
                        <div className="mb-6">
                            ...
                            {(data.personal_info.image instanceof Blob || data.personal_info.image instanceof File) && (
                                <img src={URL.createObjectURL(data.personal_info.image)} alt="Profile" className="w-32 h-32 object-cover rounded-full mx-auto" />
                            )}
                            {(typeof data.personal_info.image === 'object' && data.personal_info.image?.url) && (
                                <img src={data.personal_info.image.url} alt="Profile" className="w-32 h-32 object-cover rounded-full mx-auto" />
                            )}
                        </div>
                    ) : null}
                </div>
                            ...
                            <div className="space-y-4">
                                {data.projects.map((project, index) => (
                                    <div key={index}>
                                        ...
                                        {project.link && (
                                            <a href={project.link} target="_blank" rel="noreferrer" className="text-blue-600 hover:underline break-all text-sm ">
                                                {project.link}
                                            </a>
                                        )}
                                        {project.description && (
